...
<div class="mx-4">
    <form class="space-y-8" method="post" action="/admin/category/{{ $categories->id }}" enctype="multipart/form-data">
      @method('put')
      @csrf
      <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5"> 
        <div>
          <div>
            <h3 class="text-4xl leading-6 font-medium text-blue-500">Edit  Category</h3>
            ...
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div class="mt-1 sm:mt-0 sm:col-span-2">
                <div class="max-w-lg flex rounded-md shadow-sm">
                  <input type="text" name="name" id="name" autocomplete="name" class="flex-1 block w-full focus:ring-indigo-500 focus:border-indigo-500 min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300" value="{{ $categories->name }}">
                </div>
              </div>
            </div>
